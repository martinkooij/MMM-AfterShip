...
//		printMap(statMap);
		for (const rawItem of rawList) {
			...
			try {
				...
				item.status = statMap.get(rawItem.tag.toLowerCase())?statMap.get(rawItem.tag.toLowerCase()):"pending" ; // only known statuses are passed all others are mapped to "pending"
